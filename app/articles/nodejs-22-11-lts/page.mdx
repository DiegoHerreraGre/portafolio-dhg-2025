...
export const article = {
  ...
  date: '2024-10-29',
  title: 'Node.js 22.11.0 LTS: La Nueva Era del Runtime de JavaScript',
  description:
    'Un análisis profundo de las nuevas características revolucionarias de Node.js 22.11.0 LTS y cómo mantiene su dominio frente a competidores emergentes como Deno y Bun en el ecosistema de JavaScript.',
}
...
<Image src={NodeJs} alt="nodejs" quality={75} />
...
3. APIs modernas y ergonómicas
4. Compatibilidad con ESM
